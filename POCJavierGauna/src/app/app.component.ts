...
export class AppComponent {
  ...
  */
  ...
  sortDepartmentsByQuantity() {
     ...
     */
    this.deparmentsOutput = this.helpers.sortArrayOfObjectsByQuantity(
      this.deparmentsOutput,
      true
    );
  ...
  sortBrandsByName() {
     ...
     */
    this.brandsOutput = this.helpers.sortArrayOfObjectsByName(
      this.brandsOutput,
      false
    );
  ...
  manipulateTree() {
     ...
     */
    this.categoriesTree = this.helpers.addRamdonChildrenInCategorieByName(
      this.categoriesTree,
      'Leche'
    );
    this.categoriesTree = this.helpers.addRamdonChildrenInCategorieByName(
     ...
     */
    this.countOfNotChildrenInlevels = Object.entries(
      this.helpers.countNoChildrenCategoryInlevels(this.categoriesTree)
    );
  ...
  exampleOfPriceAndProductModel() {
    ...
    const price: PriceModel = new PriceModel(
      16000,
      'pesos argentinos',
      'AR$',
      '$'
